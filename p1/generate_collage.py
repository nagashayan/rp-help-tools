...
img_hs = process_frame('../images/paper_collage_frames/A_True_Positive.png', 'handshake')
img_wave = process_frame('../images/paper_collage_frames/A_True_Positive.png', 'wave')
img_hf = process_frame('../images/paper_collage_frames/C_False_Positive.png', 'highfive')
img_fb = process_frame('images/paper_collage_frames/D_False_Negative.png', 'fistbump')
