...
OUTPUT_DATASET_DIR = "../images/train_dataset_v5_cropped"
...
def calculate_handshake_score(lms):
    """
    Ranks a hand using the EXACT formulas from benchmark_script_v5.py
    """
    score = 0.0
    ...
    # If it falls within your benchmark's valid tilt range (60 to 120)
    if 60 < tilt < 120:
        score += 50.0  # Massive bonus for having the correct palm angle
        
    # 3. THUMB DISTANCE - REMOVED
    # As proven in benchmark testing, 2D perspective overlap causes false rejections.
